package com.railway.manager.utils;
...
public class VerifyCodeUtils {
    ...
    public static String outputImageBase64(int w, int h, String code) throws IOException {
        ...
        try {
            ...
            imgsrc = Base64Utils.encodeToString(bs.toByteArray());
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
            try {
    ...
    private static BufferedImage getBufferedImage(int w, int h, String code) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            g2.drawLine(x, y, x + xl + 140, y + yl + 120);
        }
        // 添加噪点
        // 噪声率
        ...
        int fontSize = h - 4;
        Font font = new Font("Algerian", Font.ROMAN_BASELINE, fontSize);
        g2.setFont(font);
